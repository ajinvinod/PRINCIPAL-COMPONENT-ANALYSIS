...
y2=nmf_comp[1000].reshape(4,4)
plt.subplot(4,5,12)
plt.imshow(y2,cmap='Greys')

y3=nmf_comp[2000].reshape(4,4)
plt.subplot(4,5,13)
plt.imshow(y3,cmap='Greys')

y4=nmf_comp[3000].reshape(4,4)
plt.subplot(4,5,14)
plt.imshow(y4,cmap='Greys')

y5=nmf_comp[4000].reshape(4,4)
plt.subplot(4,5,15)
...
#print('DL component shape:',dl_comp.shape)

z1=dl_comp[0].reshape(4,4)
plt.subplot(4,5,16)
plt.imshow(z1,cmap='Greys')

z2=dl_comp[1000].reshape(4,4)
plt.subplot(4,5,17)
plt.imshow(z2,cmap='Greys')

z3=dl_comp[2000].reshape(4,4)
plt.subplot(4,5,18)
plt.imshow(z3,cmap='Greys')
z4=dl_comp[3000].reshape(4,4)
plt.subplot(4,5,19)
plt.imshow(z4,cmap='Greys')
z5=dl_comp[4000].reshape(4,4)
plt.subplot(4,5,20)
